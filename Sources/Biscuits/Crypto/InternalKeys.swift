...
extension Biscuit {
    enum InternalPrivateKey: Hashable {
        ...
        func sealingSignature(for block: Block, interner: BlockInternmentTable) throws -> Data {
            return try self.signature(for: block.sealingSignatureInput(interner: interner))
        }
